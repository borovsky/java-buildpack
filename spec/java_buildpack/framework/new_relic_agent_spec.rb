...
describe JavaBuildpack::Framework::NewRelicAgent, :focus do
  ...
  context do
    ...
    it 'should download New Relic agent JAR',
      ...
      expect(app_dir + ".java-buildpack/new_relic_agent/new_relic_agent-#{version}.jar").to exist
    end
    ...
    it 'should copy resources',
      ...
      expect(app_dir + '.java-buildpack/new_relic_agent/newrelic.yml').to exist
    end
