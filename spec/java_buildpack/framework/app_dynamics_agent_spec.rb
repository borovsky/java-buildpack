...
describe JavaBuildpack::Framework::AppDynamicsAgent, focus: true, show_output: true, logging_level: 'DEBUG' do
  ...
  context do
    ...
    it 'should expand AppDynamics agent zip',
      ...
      expect(app_dir + '.java_buildpack/app_dynamics_agent/javaagent.jar').to exist
    end
